...
export default function NewReviewPage({ params }: PageProps) {
  ...
  const checkEligibility = async () => {
    ...
    if (!enrollmentData || enrollmentData.progress < 20) {
      alert('20% 이상 수강 후 리뷰를 작성할 수 있습니다.')
    ...
    if (existingReview) {
      ...
      router.push(`/courses/${params.id}/reviews/${existingReview.id}/edit`)
    }
  }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">수강평 작성</h1>
            {course && (
